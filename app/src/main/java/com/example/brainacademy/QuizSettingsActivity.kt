...
class QuizSettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        radioGroup = findViewById(R.id.quiz_length_radio_group)
        startButton = findViewById(R.id.generate_quiz)

        // Populate the category spinner with data from Firebase
        ...
        startButton.setOnClickListener {
            ...
            var numQuestions = 0
            when (selectedRadio) {
                R.id.radio_btn_5 -> numQuestions = 5
                R.id.radio_btn_10 -> numQuestions = 10
                R.id.radio_btn_15 -> numQuestions = 15
                R.id.radio_btn_20 -> numQuestions = 20
            }
            ...
            // Start the QuizActivity with the selected category and number of questions
            val intent = Intent(this, QuizActivity::class.java).apply {
                putExtra("category", selectedCategory)
                putExtra("length", numQuestions)
            }
...
//                    val selectedCategory = categorySpinner.selectedItem.toString()
//                    val quizselectedLength = findViewById<RadioGroup>(R.id.quiz_length_radio_group)
//                    var length = 0
//                    val quizLength = when(quizselectedLength) {
//                        R.id.radio_btn_5 -> length = 5
//                        R.id.radio_btn_10 -> 10
//                        else -> 10
//                    }
//                    val intent = Intent(this@QuizSettingsActivity, QuizActivity::class.java)
